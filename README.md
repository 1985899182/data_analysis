...
### 文档撰写与思路规划
- 推荐工具：**DeepSeek**
- 适用场景：`analysis.directions.txt` 文档编写、项目整体思路梳理
- 实测验证：【项目：深圳市二手房房价分析及预测】使用免费版 ChatGPT 生成思路效果不佳，DeepSeek 更适配该类场景

### 代码更新与错误修复
1. 最优方案：使用**专业 AI 代码工具**（代码专用工具效率与准确性更高）
2. 网页模型备选方案：仅使用通用网页版大模型（DeepSeek、豆包等）时，**优先选择 ChatGPT** 进行代码修改，优化效果更优
